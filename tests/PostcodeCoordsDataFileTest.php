...
class PostcodeCoordsDataFileTest extends TestCase
{
	...
	{
		$this->pc = new NearestSchools\PostcodeCoordsDataFile();
	}
	...
	public function testNonDefaultPath()
	{
		...
		$pc = new NearestSchools\PostcodeCoordsDataFile(dirname($testFilePath));
	...
	{
		$coords = NearestSchools\PostcodeCoordsDataFile::Coords();
